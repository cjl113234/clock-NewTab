...
ant-select-selection-search.ant-select-single .ant-select-selector .ant-select-selection-search-input {
  width: 10%;
  opacity: 0.3;
...
.global-search-wrapper
  > :global(.ant-input .ant-select-selection-search-input) {
  position: absolute;
